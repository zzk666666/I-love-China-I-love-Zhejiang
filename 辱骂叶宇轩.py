...
aw1=["叶宇轩是贱逼、叶宇轩欺负女人不要脸","打的叶宇轩狗不吃叶宇轩","电锯惊魂来叶宇轩家了","瘦长鬼影使叶宇轩发高烧最后离奇失踪","我自横刀向天笑，去留肝胆两昆仑！","君子报仇十年不晚，有恩报恩有仇报仇","此头须向国门悬，必杀叶（指叶宇轩的兵）家军十万！","叶宇轩不小心进了游戏遭遇头号玩家的轮番攻击","叶宇轩去了火葬场火化","把叶宇轩分尸、碎石、再烹尸！","把叶宇轩骨灰扔进日本海里","叶宇轩根本没有钱，因为他的钱拿去嫖娼了","震惊！叶宇轩猥亵香山中学（高中部）校长的女儿","叶宇轩四季如春（一年四季发春）"]
...
if __name__=='__main__':
    ...
    print(f"大家好我是{t1.getName()}战队我是第一个出场，我是（1）大家记住我的编号")
    print(f"大家好我是{t2.getName()}战队我是我第二个出场，我是（2）大家记住我的编号")
    print("注：（3）代表起哄的观众")
    time.sleep(3)
    t1.start()
    t2.start()
